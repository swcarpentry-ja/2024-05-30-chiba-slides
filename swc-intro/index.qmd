...
- [ソフトウェアのインストール（git、docker）](https://swcarpentry-ja.github.io/2024-05-30-chiba/#setup)

- ファイルのダウンロード
  - [bash](https://swcarpentry-ja.github.io/shell-novice/#download-files)
  - [docker](https://carpentries-incubator.github.io/docker-introduction/setup.html#files-to-download)

- [ワークショップ前アンケート](https://carpentries.typeform.com/to/CvmMM8re?slug=2024-05-30-chiba)
...
上記のリンクからレッスンの内容にアクセスできます<br>（翻訳がまだ完了していない部分があります）
...
インストラクターが聞かなくても、何か問題があった時に**声をかけて下さい**
